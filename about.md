...
title: About
layout: page
description: "Cartesian Trees is a JEI-certified AI solution partner based in Paris. We help companies integrate LLMs, build agentic systems, deploy Bayesian inference in production, and ship AI-powered applications — from strategy through to working software."
...
We started with a research question: what if your database could reason under uncertainty? That led us to build [Bayesian inference algorithms directly into PostgreSQL](https://github.com/cartesiantrees/postgres-bayes) — MCMC sampling, Gibbs sampling, variational inference — running where the data lives instead of in a separate Python process. That research earned us **Jeune Entreprise Innovante (JEI)** status from the French government, which is their recognition that a company is doing genuine R&D, not just applying existing tools.
...
Engineering degree from [IIT Roorkee](https://www.lesechos.fr/weekend/business-story/inde-dans-les-coulisses-de-ces-ecoles-qui-faconnent-lelite-de-la-silicon-valley-1397124) (B.Tech, 2012–2016). Before starting Cartesian Trees, Ayush worked with both American and French companies across a wide range of engineering challenges: contributing to [Stripe's](https://github.com/stripe) payment infrastructure, building Facebook's Conversion API integrations, contributing to [Metabase](https://github.com/metabase/metabase) (open-source BI), and working on [Pyodide](https://github.com/pyodide/pyodide) (Python in the browser).
...
If you're figuring out how AI fits into your product, or you've started and hit the wall between "demo" and "production" — [we should talk](/contact). We're most useful when you have real data, a real problem, and a team that's ready to build.
